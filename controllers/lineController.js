// lineController.js (Dialogflow型完全版)
...
// MEMO: In production, consider persisting sessionMap (e.g., Redis) to retain context after server restarts
  ...
  try {
    ...
    for (const event of events) {
      ...
      try {
        ...
        console.error('Embedding FAQジャンプエラー:', embeddingError.message);
      }

      // ③ 通常ナビゲート（配送→ご注文前/後→小分類）
